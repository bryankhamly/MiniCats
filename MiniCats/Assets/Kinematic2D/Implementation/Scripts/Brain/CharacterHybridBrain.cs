...
namespace Lightbug.Kinematic2D.Implementation
{
    ...
    public class CharacterHybridBrain : CharacterBrain
    {
        ...
        void UpdateHumanBrain()
        {
            ...
            characterAction.right |= horizontal > 0;
            characterAction.left |= horizontal < 0;
            characterAction.up |= vertical > 0;
            characterAction.down |= vertical < 0;
        ...
        void UpdateFollowBehaviour()
        {
            ...
            float signedAngle = Utilities.SignedAngle(transform.up, Vector3.up, Vector3.forward);
